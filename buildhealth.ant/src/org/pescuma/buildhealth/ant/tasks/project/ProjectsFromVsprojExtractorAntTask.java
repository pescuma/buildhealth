...
public class ProjectsFromVsprojExtractorAntTask extends FileListBuildHealthAntSubTask {
	
	@Override
	protected void execute(BuildHealth buildHealth) {
		List<File> files = getFiles();
		
		buildHealth.extract(new ProjectsFromVsprojExtractor(new PseudoFiles(files)));
	}
