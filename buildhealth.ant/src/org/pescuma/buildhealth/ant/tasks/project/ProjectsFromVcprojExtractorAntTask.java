...
public class ProjectsFromVcprojExtractorAntTask extends FileListBuildHealthAntSubTask {
	
	@Override
	protected void execute(BuildHealth buildHealth) {
		List<File> files = getFiles();
		
		buildHealth.extract(new ProjectsFromVcprojExtractor(new PseudoFiles(files)));
	}
