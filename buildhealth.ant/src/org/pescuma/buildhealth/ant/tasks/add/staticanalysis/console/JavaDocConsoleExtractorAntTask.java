...
public class JavaDocConsoleExtractorAntTask extends FileListBuildHealthAntSubTask {

	@Override
	protected void execute(BuildHealth buildHealth) {
		buildHealth.extract(new JavaDocConsoleExtractor(new PseudoFiles(getFiles())));
	}
