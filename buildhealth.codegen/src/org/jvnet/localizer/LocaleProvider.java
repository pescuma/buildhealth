 ...
 * 
 * <p>
 * For example, in webapps, you might use the current request's <tt>Accept-Language</tt> header, or maybe it's just an
 * invocation to {@link Locale#getDefault()}.
 * 
 * <p>
 * A single instance of {@link LocaleProvider} is maintained in this class for the use by {@link ResourceBundleHolder}.
 * 
